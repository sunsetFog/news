...
const baseWebpackConfig = require('./webpack.base.conf') // 引入文件
const CopyWebpackPlugin = require('copy-webpack-plugin') // webpack复制
...
const webpackConfig = merge(baseWebpackConfig, { // 合并文件
  module: {
