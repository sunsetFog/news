...
export default {
    ...
    methods: {
        ...
        queryWay() {
            ...
            that.$apihttp({
                url: process.env.core_url + '/sky/homeRecommendSubject/list',
                method: 'get',
                params: params
            })
                .then(res => {
        ...
        switchChange(value, row) {
            ...
            that.$confirm('是否要修改推荐状态?', '提示', {
                ...
                .then(() => {
                    ...
                    that.$apihttp({
                        url: process.env.core_url + '/sky/homeRecommendSubject/update',
                        method: 'post',
                        data: params
                    })
                        .then(res => {
        ...
        deleteWay(row) {
            ...
            that.$confirm('是否要删除该推荐?', '提示', {
                ...
                .then(() => {
                    ...
                    that.$apihttp({
                        url: process.env.core_url + '/sky/homeRecommendSubject/delete',
                        method: 'get',
                        params: params
                    })
                        .then(res => {
