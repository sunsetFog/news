<template>
    <section id="freshUnit" ref="refUnit">
        ...
        <addDialog ref="add" @sureWay="queryWay" :sure_active="2"></addDialog>
...
export default {
    ...
    methods: {
        ...
        queryWay() {
            ...
            that.$apihttp({
                url: process.env.core_url + '/sky/homeNewProduct/list',
                method: 'get',
                params: params
            })
                .then(res => {
        ...
        deleteWay(row) {
            ...
            that.$confirm('是否要删除该推荐?', '提示', {
                ...
                .then(() => {
                    ...
                    that.$apihttp({
                        url: process.env.core_url + '/sky/homeNewProduct/delete',
                        method: 'get',
                        params: params
                    })
                        .then(res => {
