<template>
    <section id="hotUnit" ref="refUnit">
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="商品名称:">
                            <el-input v-model="queryData.productName" placeholder=""></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
        ...
        <addDialog ref="add" @sureWay="queryWay" :sure_active="3"></addDialog>
...
<script>
import addDialog from "../flash/flashProductRelation/addDialog.vue"
...
export default {
    ...
    methods: {
        ...
        queryWay() {
            ...
            that.$apihttp({
                url: process.env.core_url + '/sky/homeRecommendProduct/list',
                method: 'get',
                params: params
            })
                .then(res => {
        ...
        switchChange(value, row) {
            ...
            that.$confirm('是否要修改推荐状态?', '提示', {
                ...
                .then(() => {
                    ...
                    that.$apihttp({
                        url: process.env.core_url + '/sky/homeRecommendProduct/update',
                        method: 'post',
                        data: params
                    })
                        .then(res => {
        ...
        deleteWay(row) {
            ...
            that.$confirm('是否要删除该推荐?', '提示', {
                ...
                .then(() => {
                    ...
                    that.$apihttp({
                        url: process.env.core_url + '/sky/homeRecommendProduct/delete',
                        method: 'get',
                        params: params
                    })
                        .then(res => {
