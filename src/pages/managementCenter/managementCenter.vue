    ...
    data(){
        return{
            ...
            menuList: [{key: '1',label: '知识点',path: '',icon: '../../../static/dream/center/pai.png',effect:[
                {key:'1-2-1',label: 'v-标签',path:'/v_tag',icon: '../../../static/dream/center/qipai.png',effect:[]},
                {key:'1-2-2',label: 'vue修饰符',path:'/modifier',icon: '../../../static/dream/center/qipai.png',effect:[]},
                {key:'1-2-3',label: '生命周期',path:'/lifecycle',icon: '../../../static/dream/center/qipai.png',effect:[]},
                {key:'1-2-4',label: 'vuex',path: '/vuex',icon: '../../../static/dream/center/tuandui.png',effect:[]},
                {key:'1-2-5',label: '组件遍历',path: '/ergodic',icon: '../../../static/dream/center/daili.png',effect:[]},
                {key:'1-2-6',label: '路由传参',path: '/router',icon: '../../../static/dream/center/wanjia.png',effect:[]},
                {key:'1-2-7',label: '动态样式',path: '/class',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-8',label: '引用less',path: '/quote',icon: '../../../static/dream/center/shouyi.png',effect:[]},
                {key:'1-2-9',label: '子父通讯',path: '/parent',icon: '../../../static/dream/center/tuiguang.png',effect:[]},
                {key:'1-2-10',label: '全局方法',path: '/public',icon: '../../../static/dream/center/gonggao.png',effect:[]},
                {key:'1-2-11',label: 'watch监听',path: '/watch',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-12',label: 'computed',path: '/computed',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-13',label: 'es6',path: '/es6',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-14',label: 'filters',path: '/filters',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-15',label: 'transition',path: '/transition',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-16',label: 'refs',path: '/refs',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-17',label: 'canvas',path: '/canvas',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-18',label: 'echarts图表',path: '/echarts',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-19',label: 'base64解密',path: '/base64',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-20',label: 'mock模拟接口',path: '/mock',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-21',label: '缓存',path: '/cache',icon: '../../../static/dream/center/caiwu.png',effect:[]},
                {key:'1-2-22',label: 'axios配置',path: '/axios',icon: '../../../static/dream/center/caiwu.png',effect:[]}
                ]},
                ...
                {key: '2-2-5',label: '分页封装',path: '/pagination',icon: '../../../static/dream/center/qipai.png',effect:[]},
