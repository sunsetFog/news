<template>
    <section>
        <div id="box" class="category" name="coffee" style="color: white;">咖--咖</div>
    </section>
</template>
...
export default {
    ...
    methods: {
        demo1(){
            // javascript脚本语言组成结构:语法标准,文档对象模型,浏览器对象模型
            //四种输出类型
            alert('alert内容');//弹出框
            prompt("prompt内容");//对话框
        ...
        demo2(){
            ...
            yuansu.style.backgroundColor = "red";
