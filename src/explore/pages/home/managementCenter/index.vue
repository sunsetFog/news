...
export default{
    ...
    data(){
        return{
            ...
            //         {key: lodash.uniqueId('second_'), title: 'pc自适应', path: '/adaption', icon: require('@static/picture/center/qipai.png'), children:[]},
            //         {key: lodash.uniqueId('second_'), title: '水波', path: '/wave', icon: require('@static/picture/center/qipai.png'), children:[]},
