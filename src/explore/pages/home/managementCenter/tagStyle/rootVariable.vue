...
<!--
    ...
    var()函数 参数2表示变量的默认值。如果该变量不存在，就会使用这个默认值
    calc()计算函数 字符串拼接--添加单位  height: calc(var(--boxHeight) * 1px);
    作用域: :root是html标签内能访问css变量
 -->
<script>
// 设置变量
document.body.style.setProperty('--boxHeight', '250px');
